...
public class StudentDataListener implements ReadListener<Student> {
     ...
     */
    Logger log = LoggerFactory.getLogger(StudentDataListener.class);
    ...
    public StudentDataListener(StudentDataDao studentDataDao) {
...
//        demoDAO.save(cachedDataList);
        studentDataDao.insert(cachedDataList);
        log.info("存储数据库成功！");
    }
